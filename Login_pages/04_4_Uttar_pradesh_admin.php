...
$query = "SELECT cc.* 
          ...
          WHERE cc.institute_state='Uttar_Pradesh' AND s.institute_status='Accepted'";
...
if (!$result) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td>" . "<a href='10_see_Uttar_pradesh_students.php?user_name=$usernamedata'><button>View</button></a>". "</td>";
        // Add more columns as per your database schema
        echo "</tr>";
    }
    echo "</table>";
