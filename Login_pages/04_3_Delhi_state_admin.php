...
$query = "SELECT cc.* 
          ...
          WHERE cc.institute_state='Delhi' AND s.institute_status='Accepted'";
...
if (!$result) {
    ...
    echo "<table border='1'>
            <tr style='background-color: aqua;'> <!-- Set background color here -->
                <th>User ID</th>
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td>" . "<a href='10_see_delhi_students.php?user_name=$usernamedata'><button>View</button></a>". "</td>";
        // Add more columns as per your database schema
        echo "</tr>";
    }
    echo "</table>";
