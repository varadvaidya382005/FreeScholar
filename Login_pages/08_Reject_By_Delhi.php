...
$queryForAddress = "Delete FROM `address_info` WHERE user_name = '$user_id'";
$queryForUser_info = "Delete FROM `user_info` WHERE user_name = '$user_id'";
$queryForPastQualification = "Delete FROM `past_qualification` WHERE user_name = '$user_id'";
$queryForCurrentCourseDetails = "Delete FROM `current_course` WHERE user_name = '$user_id'";
$queryForSchemes = "Delete FROM `user_from` WHERE 'user_name' = '$user_id'";
