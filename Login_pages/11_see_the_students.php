...
if (isset($_GET['user_name'])) {
    ...
    $queryForAddress = "SELECT * FROM `address_info` WHERE user_name = '$user_id'";//user_name
...
echo "<caption style='color: red; text-align: left;'>Address Information</caption>";
    ...
    // echo "<th>user_id</th>";
        ...
        while ($rowins = mysqli_fetch_assoc($result_for_past_qualification)) {
            ...
            echo "<a href='08_Accept_By_Maharashtra.php?user_name=$user_id'><input type='button' value='Accept'style='background-color: green; color: white;></a>";
            echo "<a href='08_Reject_By_Delhi.php?user_name=$user_id'><input type='button' value='Reject' style='background-color: red; color: white;'></a>";
